...
// const Profile: React.FC = () => {
//   const navigation = hooks.useAppNavigation();
//   const user = useSelector((state: RootState) => state.userSlice.user); // Access user state from Redux

//   const emailVerified = user?.emailVerified || false;
//   const phoneVerified = user?.phoneVerified || false;

//   // Alert to notify user that phone number is verified
//   const phoneVerifiedAlert = (): void => {
//     Alert.alert(
//       'Phone number is verified',
//       'Your phone number is already verified.',
...
//   // Alert to notify user that email is verified
//   const emailVerifiedAlert = (): void => {
//     Alert.alert(
//       'Email is verified',
//       'Your email is already verified.',
...
//   // Render user info component with navigation logic
//   const renderUserInfo = (): JSX.Element => {
//     return (
//       <components.UserData
//         onPress={() => {
//           if (user?.emailVerified && user?.phoneVerified) {
//             navigation.navigate('EditProfile'); // Navigate to edit profile screen if both verified
//             return;
//           }
...
//   // Render profile menu items with navigation logic based on verification status
//   const renderMenu = (): JSX.Element => {
//     return (
//       <View style={{ paddingLeft: 20 }}>
//         <items.ProfileItem
...
//         />
//         <items.ProfileItem
//           title={phoneVerified ? 'Your phone number is verified' : 'Verify phone number'}
//           onPress={() => {
//             phoneVerified ? phoneVerifiedAlert() : navigation.navigate('SendPhoneOtp');
//           }}
//           goNavigation={!phoneVerified}
//           icon={<svg.SmartphoneSvg phoneVerified={phoneVerified} />}
//           containerStyle={{ marginBottom: utils.responsiveHeight(10) }}
...
//           title={emailVerified ? 'Your email is verified' : 'Verify email'}
//           onPress={() => {
//             emailVerified ? emailVerifiedAlert() : navigation.navigate('SendEmailOtp');
//           }}
//           goNavigation={!emailVerified}
//           icon={<svg.MailSvg emailVerified={emailVerified} />}
//           containerStyle={{ marginBottom: utils.responsiveHeight(10) }}
