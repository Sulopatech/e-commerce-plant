...
export type BannersFilterParameter = {
  _and?: InputMaybe<Array<BannersFilterParameter>>;
  _or?: InputMaybe<Array<BannersFilterParameter>>;
  createdAt?: InputMaybe<DateOperators>;
...
export type BannersList = PaginatedList & {
  __typename?: 'BannersList';
  items: Array<Banners>;
  totalItems: Scalars['Int']['output'];
};

export type BannersListOptions = {
  /** Allows the results to be filtered */
  filter?: InputMaybe<BannersFilterParameter>;
  /** Specifies whether multiple top-level "filter" fields should be combined with a logical AND or OR operation. Defaults to AND. */
  filterOperator?: InputMaybe<LogicalOperator>;
  /** Skips the first n results, for use in pagination */
  skip?: InputMaybe<Scalars['Int']['input']>;
  /** Specifies which properties to sort the results by */
  sort?: InputMaybe<BannersSortParameter>;
  /** Takes n results, for use in pagination */
  take?: InputMaybe<Scalars['Int']['input']>;
};

export type BannersSortParameter = {
  createdAt?: InputMaybe<SortOrder>;
...
export type QueryBannersArgs = {
  options?: InputMaybe<BannersListOptions>;
};
